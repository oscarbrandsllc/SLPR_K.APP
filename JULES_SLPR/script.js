// --- DOM Elements ---
        ...
        async function handleFetchRosters() {
            ...
            try {
                ...
                if (state.leagues.length > 0) {
                    ...
                    // If user has no leagues, hide the contextual controls
        ...
        function createPositionalTeamCard(team) {
            ...
            const populate = (sel, data, creator) => {
                ...
                if (!filterActive || state.activePositions.has(pos) || (isFlexActive && ['RB', 'WR', 'TE'].includes(pos))) {
                    ...
                    const h3 = el.querySelector('h3');
                    el.innerHTML = ''; // Clear for repopulation
                    el.appendChild(h3);
        ...
        function renderTradeBlock() {
            ...
            tradeSimulator.style.display = 'block'; // Changed to block
            ...
            if (teamNames.length === 2) {
                ...
                if (diff > 500) { // Using a smaller threshold for visual effect
        ...
        function createPlayerListHeader() {
            ...
            header.innerHTML = `
                ...
                <div class="pl-player-info">
                    <div class="pl-player-name">Player & Info</div>
                </div>
